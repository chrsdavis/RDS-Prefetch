...
17:                                               ; preds = %14
  ...
  %21 = call i32 @atoi(ptr noundef %20) #11
...
define dso_local ptr @old_main() #0 {
  ...
  %33 = call noalias ptr @malloc(i64 noundef 1064) #12
...
define dso_local void @uniform_testdata(ptr dead_on_unwind noalias writable sret(%struct.datapoints) align 8 %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  %37 = call double @sqrt(double noundef %36) #10, !tbaa !5
...
76:                                               ; preds = %74, %69
  ...
  %93 = call double @pow(double noundef %92, double noundef 0xBFE5555555555555) #10, !tbaa !5
  %94 = fsub double %93, 1.000000e+00
  store double %94, ptr %18, align 8, !tbaa !21
  %95 = load double, ptr %18, align 8, !tbaa !21
  %96 = call double @sqrt(double noundef %95) #10, !tbaa !5
...
151:                                              ; preds = %142
  ...
  %160 = call double @pow(double noundef %159, double noundef 3.500000e+00) #10, !tbaa !5
  %161 = fmul double %155, %160
  %162 = fcmp ogt double %152, %161
  br i1 %162, label %142, label %163, !llvm.loop !55

163:                                              ; preds = %151
  %164 = call double @sqrt(double noundef 2.000000e+00) #10, !tbaa !5
  ...
  %170 = call double @pow(double noundef %169, double noundef 2.500000e-01) #10, !tbaa !5
...
218:                                              ; preds = %215
  ...
  %221 = call double @sqrt(double noundef %220) #10, !tbaa !5
...
define dso_local void @expandbox(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr %11) #10
  call void @llvm.lifetime.start.p0(i64 8, ptr %12) #10
  call void @llvm.lifetime.start.p0(i64 1064, ptr %13) #10
  call void @llvm.lifetime.start.p0(i64 8, ptr %14) #10
  call void @llvm.lifetime.start.p0(i64 4, ptr %15) #10
...
141:                                              ; preds = %23
  call void @llvm.lifetime.end.p0(i64 4, ptr %15) #10
  call void @llvm.lifetime.end.p0(i64 8, ptr %14) #10
  call void @llvm.lifetime.end.p0(i64 1064, ptr %13) #10
  call void @llvm.lifetime.end.p0(i64 8, ptr %12) #10
  call void @llvm.lifetime.end.p0(i64 24, ptr %11) #10
  call void @llvm.lifetime.end.p0(i64 4, ptr %10) #10
...
12:                                               ; preds = %1
  %13 = call noalias ptr @malloc(i64 noundef 120) #12
...
define dso_local ptr @ubody_alloc(i32 noundef %0) #0 {
  ...
  store i32 %0, ptr %2, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 8, ptr %3) #10
  %4 = call noalias ptr @malloc(i64 noundef 144) #12
...
59:                                               ; preds = %42
  ...
  %63 = call double @sqrt(double noundef %62) #10, !tbaa !5
...
define dso_local void @error(ptr noundef %0) #0 {
  ...
  %5 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef @.str.11, ptr noundef %4) #10

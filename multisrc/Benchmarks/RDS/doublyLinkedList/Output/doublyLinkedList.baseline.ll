; ModuleID = 'Output/doublyLinkedList.linked.rbc'
...
12:                                               ; preds = %7
  ...
  %13 = call noalias ptr @malloc(i64 noundef 24) #7
...
20:                                               ; preds = %17
  ...
  %24 = call i32 @atoi(ptr noundef %23) #8
...
25:                                               ; preds = %20, %17
  ...
  call void @srand(i32 noundef %27) #6

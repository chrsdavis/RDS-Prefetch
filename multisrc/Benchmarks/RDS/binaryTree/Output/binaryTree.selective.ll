; ModuleID = 'Output/binaryTree.selective.bc'
...
25:                                               ; preds = %11
  ...
  %rds.field.ptr1 = getelementptr inbounds %struct.TreeNode, ptr %28, i32 0, i32 1
...
8:                                                ; preds = %1
  ...
  %rds.field.ptr1 = getelementptr inbounds %struct.TreeNode, ptr %20, i32 0, i32 1
  %rds.field.val2 = load ptr, ptr %rds.field.ptr1, align 8
  call void @llvm.prefetch.p0(ptr %rds.field.val2, i32 0, i32 3, i32 1)
...
6:                                                ; preds = %1
  ...
  %rds.field.ptr1 = getelementptr inbounds %struct.TreeNode, ptr %12, i32 0, i32 1
  %rds.field.val2 = load ptr, ptr %rds.field.ptr1, align 8
  call void @llvm.prefetch.p0(ptr %rds.field.val2, i32 0, i32 3, i32 1)
